var o=class extends HTMLElement{mode="login";connectedCallback(){this.render(),this.attachEventListeners()}render(){let e=this.mode==="login";this.innerHTML=`
        ...
        `}};customElements.define("nerd-gui",s);
